...
# Info on code
Uses React + TypeScript + Vite from a template that provides a minimal setup to get React working in Vite with HMR and some ESLint rules.
# Next steps
Needless to say, there is a lot more that can and needs to be addded. Online game play doesn't really work. AI mode does work, but would benefit from an option to increase the search depth. I hope some of you coding wizards can take this from here and make this shine...
